...
CREATE TABLE p39_member_address(
  ...
  province_id mediumint unsigned not null COMMENT '省份ID',
  city_id mediumint unsigned not null COMMENT '城市ID',
  district_id mediumint unsigned not null COMMENT '城区ID',
