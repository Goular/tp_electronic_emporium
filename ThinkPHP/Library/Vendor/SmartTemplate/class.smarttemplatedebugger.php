	...
	class SmartTemplateDebugger
	{
		...
		*/
		function start ( $vars )
		{
			...
			echo '<html><head><script type="text/javascript">
					...
					var v = el.Styles.display == "block";
					var str = src.innerHTML;
					el.Styles.display = v ? "none" : "block";
			...
			echo '<table border="0" cellpadding="4" cellspacing="1" width="100%" bgcolor="#C6D3EF"><tr><td bgcolor="#F0F0F0"><pre id="Template" Styles="display:block">';
			echo $page;
			...
			if (@include_once ("class.smarttemplateparser.php"))
			{
				...
				echo '<table border="0" cellpadding="4" cellspacing="1" width="100%" bgcolor="#C6D3EF"><tr><td bgcolor="#F0F0F0"><pre id="Compiled" Styles="display:block">';
			...
			echo '<table border="0" cellpadding="4" cellspacing="1" width="100%" bgcolor="#C6D3EF"><tr><td bgcolor="#F0F0F0"><pre id="Data" Styles="display:block">';
		...
		*/
		function toggleview ( $suffix = '')
		{
			...
			$ret =  '[' . $suffix . '<a href="javascript:void(\'\');" onclick="toggleVisibility(document.getElementById(\'Block' . $spancnt . '\'), this); return false">Hide Block</a>]<span id="Block' . $spancnt . '" Styles="display:block">';
			return $ret;
		}
